...
npm install pm2 -g
curl -s -L https://deb.nodesource.com/setup_20.x | bash -
sudo apt-get install nodejs -y
# ========================

git clone https://github.com/johnnyrodriguezdk/paineldtunnel.git /root/paineldtunnel
cd /root/paineldtunnel
...
rm /root/install.sh
pon
echo -e "\033[1;36mTU PANEL:\033[1;37m http://$IP:$porta\033[0m"
echo
